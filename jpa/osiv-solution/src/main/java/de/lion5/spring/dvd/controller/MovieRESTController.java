...
public class MovieRESTController {
  ...
  public ResponseEntity<Long> countMovies() {
    long numberOfMovies = movieService.countMovies();
    this.logInfo("Movie count: " + numberOfMovies);
    return ResponseEntity.ok(numberOfMovies);
  }

  @PostMapping("/v1/movies/gen")
  public ResponseEntity<Integer> generateMovies(@RequestBody int numberOfMovies) {
