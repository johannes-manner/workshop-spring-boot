...
### Task 3 - Experiment with EAGER fetch type - what happens on a sql level?
...
### Task 4 Misusing Transactions... (short spoiler: also not recommended)
...
### Task 5 - The gold standard and solution - `NamedEntityGraphs`
